...
public abstract class AbstractSDKAdapter : ScriptableObject
{
  ...
  public abstract bool GetLanguage(LanguageInfo language);
  ...
  public abstract void InvokeConsume();
  public abstract IEnumerator ConsumePurchase(Action action);
}
