...
public class PlayerPrefsSDKAdapter : AbstractSDKAdapter
{
    ...
    public override void InvokeConsume()
    {
//        throw new NotImplementedException();
    }

    public override IEnumerator ConsumePurchase(Action action)
    {
        yield break;
    }
    ...
    public override bool GetLanguage(LanguageInfo language)
    {
        return language.Type.ToString().ToLower() == Language;
    }
